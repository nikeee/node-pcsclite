...
// Native module is built by @napi-rs/cli during install (see package.json scripts).
// Output is lib/index.js (loader) + lib/pcsclite.<platform>-<arch>.node (binary).
const { PCSCLite, CardReader } = require('./index.js');
